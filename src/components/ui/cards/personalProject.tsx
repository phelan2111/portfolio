...
import LoaderFresh from '../loader/fresh';

type CardPersonalProjectProps = {
	data: ProjectItem;
};

const CardPersonalProject = (props: CardPersonalProjectProps) => {
	...
	return (
		<div>
			<HoverCard
				...
				<div className='flex flex-col gap-8 w-full items-center justify-between h-full'>
					<LoaderFresh />
					<div className='px-8 text-white text-start w-full flex flex-col gap-4 relative justify-between h-full'>
						...
						<div className='flex flex-col justify-center items-center gap-8'>
							...
							<div className='flex flex-col gap-6'>
								...
								<div className='flex items-center justify-between'>
									<a target='_blank' href={props.data.gitHup} rel='noreferrer'>
...
export default CardPersonalProject;
