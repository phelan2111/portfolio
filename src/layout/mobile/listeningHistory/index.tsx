...
import ResponsiveMobile from '@/components/ui/responsive/mobile';
	...
	return (
		<ResponsiveMobile>
			<main className='h-screen w-screen bg-primary_dark-20 text-white pb-40'>
				...
				<section className='h-podcasts overflow-y-auto snap-mandatory snap-y animate-translateBottom_duration_0dot8'>
