...
function YourLibraryAlbumItem(props: IYourLibraryAlbumItemProps) {
	...
	return (
		<div className='flex items-center gap-4 transition-all group duration-500 translate3d-yourLibrary cursor-pointer snap-start relative hover:bg-white/10 rounded-full'>
			<div
				style={{
