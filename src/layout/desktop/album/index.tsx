	...
	return (
		<ResponsiveDesktop>
			<section className='flex flex-col h-albumDk rounded-2xl relative bg-primary_dark-10 animate-translateBottom_duration_0dot8 overflow-auto scrollHiddenY'>
				<div className='min-h-[400px] w-full flex items-center relative'>
				...
				<div className='px-10 bg-gradient-to-b from-[#FFAD60]/10 to-primary_dark-10 relative'>
					...
					<article className='py-4 gap-8 items-center flex justify-between pt-16'>
